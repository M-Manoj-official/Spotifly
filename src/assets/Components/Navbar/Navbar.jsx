...
export const Navbar = () => {
  return (
    <div className='bg-[#000000] font-Inter flex flex-row p-3 text-white justify-between items-center'>
      ...
      <div className='p-3 rounded-4xl flex flex-row gap-3 items-center text-[#b3b3b3] hover:text-[#e4e4e4]'>
        <a className='flex flex-row gap-3 justify-center items-center text-m' href="https://open.spotify.com/download" target='__blank'><MdOutlineDownloading />Install App</a>
      </div>
    </div>
  )
}
