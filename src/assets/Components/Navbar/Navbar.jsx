  ...
  return (
    <div className='bg-[#000000] font-Inter flex flex-row p-3 text-white justify-between items-center'>
      ...
      <div className='p-3 rounded-4xl flex flex-row gap-4 items-center text-[#b3b3b3]'>
        <a className='flex flex-row gap-3 justify-center items-center text-m hover:text-[#e4e4e4] hover:scale-105' href="https://open.spotify.com/download" target='__blank'><MdOutlineDownloading />Install App</a>
        <p className='hover:text-[#e4e4e4] hover:scale-105 cursor-pointer'>Signup</p>
